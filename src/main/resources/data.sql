...
insert into batch(batchid, volume, beerid, og, fg, abv, brewdate, tapdate, userid, createdby, lastupdatedby, quality, comments)
values(1, 25, 1, 1.06, 1.012, 0.05, DATE '2020-09-09', DATE '2020-09-25', 2, 'admin admin', 'admin admin', 'good', 'example comment'),
(2, 23, 1, 1.04, 1.010, 0.048, DATE '2020-10-09', DATE '2020-11-01', 1, 's s', 's s', 'bad', 'too carbonated');
